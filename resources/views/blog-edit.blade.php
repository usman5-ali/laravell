        ...
        <div class="w-full p-6  mx-auto">
            ...
            <div class="backdrop-blur-md p-8  shadow-2xl ring-1 ring-gray-200 space-y-8 rounded-2xl" style="background-color: white;padding: 20px;">
                ...
                <div class="text-center">
                    <h2 class="text-3xl font-extrabold text-gray-800">Update Blog Post</h2>
                    <p class="mt-2 text-gray-500">Update a blog image and write text on top of it.</p>
                </div>

                <!-- Form -->
                <form class="space-y-6" method="POST" action="{{ route('blogs.update', $blog->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-3">
                        ...
                        <textarea name="description" rows="4" required class="form-control">{{ old('description', $blog->description) }}</textarea>
                    </div>

                    <!-- Submit -->
                    <div class="mt-3 d-flex justify-content-center">
                        <button type="submit" class="btn btn-success bg-primary mt-2">Update Blog</button>
                    </div>
                </form>
