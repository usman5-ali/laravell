        ...
        <div class="w-full p-6  mx-auto">
            ...
            <div class="backdrop-blur-md p-8  shadow-2xl ring-1 ring-gray-200 space-y-8 rounded-2xl" style="background-color: white;padding: 20px;">
                ...
                <div class="text-center">
                    <h2 class="text-3xl font-extrabold text-gray-800">View Blog Post</h2>
                    <p class="mt-2 text-gray-500">View a blog image and write text on top of it.</p>
                </div>
                ...
                <form class="space-y-6" method="POST"
                    ...
                    <div class="mt-3">
                        ...
                        <textarea rows="4" placeholder="Write your blog description here..." required name="description"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition">{{ old('description', $blog->description ?? '') }}</textarea>
                    </div>
